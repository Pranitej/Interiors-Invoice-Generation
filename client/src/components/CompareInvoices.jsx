      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img
                src={`${import.meta.env.VITE_API_BASE}/public/${(company ?? platformConfig).logoFile}`}
                alt={`${(company ?? platformConfig).name} Logo`}
                style={{
                  width: "100%",
                  height: "100%",
                  objectFit: "contain",
            ...
            <div>
              ...
              >
                ...
                {(company ?? platformConfig).registeredOffice}
              </p>
              <p
                style={{
                  fontSize: "10px",
              ...
              >
                ...
                {(company ?? platformConfig).industryAddress}
              </p>
              <p
                style={{
                  fontSize: "10px",
              ...
              >
                ...
                {(company ?? platformConfig).phones.join(", ")} |{" "}
                <span style={{ fontWeight: "500" }}>Email: </span>
                {(company ?? platformConfig).email}
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            {(company ?? platformConfig).name} Invoice System
          </p>
          <p
            style={{
              fontSize: "12px",
