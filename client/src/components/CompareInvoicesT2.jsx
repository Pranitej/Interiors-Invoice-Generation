...
/* -------------------------------
   Invoice Comparison Report Component — Executive Navy
--------------------------------*/
...
function InvoiceComparisonReport({ invoiceA, invoiceB, company }, ref) {
  ...
  return (
    ...
    >
      {/* Report Header — Navy Band */}
      <div style={{ backgroundColor: "#0f172a", padding: "8px 10px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
            <div style={{ width: "64px", height: "64px", flexShrink: 0, marginTop: "4px", backgroundColor: "#ffffff", borderRadius: "6px", padding: "4px" }}>
              <img
            ...
            <div>
              <h1 style={{ fontSize: "24px", fontWeight: "bold", letterSpacing: "-0.025em", margin: 0, color: "#ffffff" }}>
                {(company ?? config.platform).name}
              </h1>
              <p style={{ fontSize: "10px", color: "#cbd5e1", lineHeight: "1.25", marginTop: "4px", marginBottom: "2px" }}>
                <span style={{ fontWeight: "500", color: "#fbbf24" }}>Regd Office:</span>{" "}
                {(company ?? config.platform).registeredOffice}
              </p>
              <p style={{ fontSize: "10px", color: "#cbd5e1", marginBottom: "2px" }}>
                <span style={{ fontWeight: "500", color: "#fbbf24" }}>Industry:</span>{" "}
                {(company ?? config.platform).industryAddress}
              </p>
              <p style={{ fontSize: "10px", color: "#cbd5e1" }}>
                <span style={{ fontWeight: "500", color: "#fbbf24" }}>Contact: </span>
                {(company ?? config.platform).phones.join(", ")} |{" "}
                <span style={{ fontWeight: "500", color: "#fbbf24" }}>Email: </span>
      ...
      <div style={{ padding: "24px 40px", backgroundColor: "#1e293b", borderBottom: "1px solid #334155" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <h2 style={{ fontSize: "18px", fontWeight: "bold", color: "#ffffff", margin: 0 }}>INVOICE COMPARISON</h2>
            <p style={{ fontSize: "14px", color: "#94a3b8", marginTop: "4px", marginBottom: 0 }}>
              Detailed comparison between two invoices
            </p>
          </div>
          <div style={{ textAlign: "right" }}>
            <p style={{ fontSize: "14px", color: "#94a3b8", marginBottom: "4px" }}>Total Difference</p>
            <p style={{ fontSize: "20px", fontWeight: "bold", margin: 0, color: totalDifference > 0 ? "#059669" : totalDifference < 0 ? "#dc2626" : "#ffffff" }}>
              {totalDifference > 0 ? "+" : ""}
      ...
      <div style={{ padding: "24px 40px", borderBottom: "1px solid #e5e7eb" }}>
        <h3 style={{ fontSize: "16px", fontWeight: "bold", color: "#0f172a", marginBottom: "16px", borderBottom: "2px solid #d97706", paddingBottom: "4px" }}>
          INVOICE DETAILS
        </h3>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "32px", width: contentWidth }}>
          {/* Invoice A */}
          <div>
            <div style={{ border: "1px solid #0f172a", borderRadius: "6px", padding: "16px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
                <h4 style={{ fontWeight: "bold", color: "#0f172a", margin: 0 }}>INVOICE A</h4>
                <span style={{ fontSize: "12px", backgroundColor: "#d97706", color: "#ffffff", padding: "2px 8px", borderRadius: "4px" }}>
          ...
          <div>
            <div style={{ border: "1px solid #0f172a", borderRadius: "6px", padding: "16px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
                <h4 style={{ fontWeight: "bold", color: "#0f172a", margin: 0 }}>INVOICE B</h4>
                <span style={{ fontSize: "12px", backgroundColor: "#d97706", color: "#ffffff", padding: "2px 8px", borderRadius: "4px" }}>
      ...
      <div style={{ padding: "24px 40px", borderBottom: "1px solid #e5e7eb" }}>
        ...
        <table style={{ width: "100%", fontSize: "14px", border: "1px solid #e5e7eb" }}>
          <thead>
            <tr style={{ backgroundColor: "#1e293b" }}>
              <th style={{ padding: "12px", textAlign: "left", fontWeight: "500", borderBottom: "1px solid #334155", color: "#ffffff" }}>Rate Type</th>
              <th style={{ padding: "12px", textAlign: "right", fontWeight: "500", borderBottom: "1px solid #334155", color: "#ffffff" }}>{clientA.name}</th>
              <th style={{ padding: "12px", textAlign: "right", fontWeight: "500", borderBottom: "1px solid #334155", color: "#ffffff" }}>{clientB.name}</th>
              <th style={{ padding: "12px", textAlign: "right", fontWeight: "500", borderBottom: "1px solid #334155", color: "#ffffff" }}>Difference</th>
            </tr>
          </thead>
          <tbody>
      ...
      {(roomsA.length > 0 || roomsB.length > 0) && (
        <div style={{ padding: "24px 40px", borderBottom: "1px solid #e5e7eb" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
            <h3 style={{ fontSize: "16px", fontWeight: "bold", color: "#0f172a", margin: 0, borderBottom: "2px solid #d97706", paddingBottom: "4px" }}>
          ...
          {(() => {
            ...
            return Array.from({ length: maxRooms }).map((_, idx) => {
              ...
              return (
                <div key={idx} style={{ marginBottom: "16px", border: "1px solid #0f172a", borderRadius: "4px", overflow: "hidden" }}>
                  {/* Room Header */}
                  <div style={{ backgroundColor: "#d97706", padding: "12px 16px" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <div>
                        ...
                        {(roomA.description || roomB.description) && (
                          <p style={{ fontSize: "12px", color: "#fef3c7", marginTop: "4px", marginBottom: 0 }}>
                            {roomA.description || roomB.description}
                          </p>
                        )}
                      </div>
                      <div style={{ textAlign: "right" }}>
                        <div style={{ fontSize: "12px", color: "#fef3c7" }}>Total Difference</div>
                      ...
                      <table style={{ width: "100%", fontSize: "12px" }}>
                        <thead>
                          <tr style={{ borderBottom: "1px solid #334155", backgroundColor: "#1e293b" }}>
                            <th style={{ paddingBottom: "8px", textAlign: "center", fontWeight: "500", color: "#ffffff", borderRight: "2px solid #334155" }} rowSpan="2">Item</th>
                            <th style={{ padding: "4px 0", textAlign: "center", fontWeight: "500", color: "#ffffff", borderRight: "2px solid #334155" }} colSpan="3">{clientA.name}</th>
                            <th style={{ padding: "4px 0", textAlign: "center", fontWeight: "500", color: "#ffffff", borderRight: "2px solid #334155" }} colSpan="3">{clientB.name}</th>
                            <th style={{ paddingBottom: "8px", textAlign: "center", fontWeight: "500", color: "#ffffff" }} rowSpan="2">Difference</th>
                          </tr>
                          <tr style={{ borderBottom: "1px solid #334155", backgroundColor: "#1e293b" }}>
                            <th style={{ padding: "4px 0", textAlign: "center", fontWeight: "500", color: "#cbd5e1", borderRight: "1px solid #334155" }}>Rate</th>
                            <th style={{ padding: "4px 0", textAlign: "center", fontWeight: "500", color: "#cbd5e1", borderRight: "1px solid #334155" }}>Area</th>
                            <th style={{ padding: "4px 0", textAlign: "center", fontWeight: "500", color: "#cbd5e1", borderRight: "2px solid #334155" }}>Amount</th>
                            <th style={{ padding: "4px 0", textAlign: "center", fontWeight: "500", color: "#cbd5e1", borderRight: "1px solid #334155" }}>Rate</th>
                            <th style={{ padding: "4px 0", textAlign: "center", fontWeight: "500", color: "#cbd5e1", borderRight: "1px solid #334155" }}>Area</th>
                            <th style={{ padding: "4px 0", textAlign: "center", fontWeight: "500", color: "#cbd5e1", borderRight: "2px solid #334155" }}>Amount</th>
                          </tr>
                        ...
                        <tbody>
                          ...
                          <tr style={{ borderBottom: "1px solid #f3f4f6" }}>
                            <td style={{ padding: "8px", fontWeight: "500", borderRight: "2px solid #d1d5db" }}>Frame Work</td>
                            <td style={{ padding: "8px", textAlign: "center", fontWeight: "500", borderRight: "1px solid #e5e7eb" }}>{formatINR(roomFrameRateA)}</td>
                            <td style={{ padding: "8px", textAlign: "center", borderRight: "1px solid #e5e7eb" }}>{aggA.frameAreaTotal?.toFixed(2) || "0.00"}</td>
                            <td style={{ padding: "8px", textAlign: "center", fontWeight: "500", borderRight: "2px solid #d1d5db" }}>{formatINR(aggA.framePriceTotal || 0)}</td>
                            <td style={{ padding: "8px", textAlign: "center", fontWeight: "500", borderRight: "1px solid #e5e7eb" }}>{formatINR(roomFrameRateB)}</td>
                            <td style={{ padding: "8px", textAlign: "center", borderRight: "1px solid #e5e7eb" }}>{aggB.frameAreaTotal?.toFixed(2) || "0.00"}</td>
                            <td style={{ padding: "8px", textAlign: "center", fontWeight: "500", borderRight: "2px solid #d1d5db" }}>{formatINR(aggB.framePriceTotal || 0)}</td>
                          ...
                          {/* Box Work */}
                          <tr style={{ borderBottom: "1px solid #f3f4f6" }}>
                            <td style={{ padding: "8px", fontWeight: "500", borderRight: "2px solid #d1d5db" }}>Box Work</td>
                            <td style={{ padding: "8px", textAlign: "center", fontWeight: "500", borderRight: "1px solid #e5e7eb" }}>{formatINR(roomBoxRateA)}</td>
                            <td style={{ padding: "8px", textAlign: "center", borderRight: "1px solid #e5e7eb" }}>{aggA.boxAreaTotal?.toFixed(2) || "0.00"}</td>
                            <td style={{ padding: "8px", textAlign: "center", fontWeight: "500", borderRight: "2px solid #d1d5db" }}>{formatINR(aggA.boxPriceTotal || 0)}</td>
                            <td style={{ padding: "8px", textAlign: "center", fontWeight: "500", borderRight: "1px solid #e5e7eb" }}>{formatINR(roomBoxRateB)}</td>
                            <td style={{ padding: "8px", textAlign: "center", borderRight: "1px solid #e5e7eb" }}>{aggB.boxAreaTotal?.toFixed(2) || "0.00"}</td>
                            <td style={{ padding: "8px", textAlign: "center", fontWeight: "500", borderRight: "2px solid #d1d5db" }}>{formatINR(aggB.boxPriceTotal || 0)}</td>
                            <td style={{ padding: "8px", textAlign: "center" }}>
                          ...
                          {/* Accessories */}
                          <tr style={{ borderBottom: "1px solid #f3f4f6" }}>
                            <td style={{ padding: "8px", fontWeight: "500", borderRight: "2px solid #d1d5db" }}>Accessories</td>
                            <td style={{ padding: "8px", textAlign: "center", color: "#9ca3af", borderRight: "1px solid #e5e7eb" }}>-</td>
                            <td style={{ padding: "8px", textAlign: "center", color: "#9ca3af", borderRight: "1px solid #e5e7eb" }}>-</td>
                            <td style={{ padding: "8px", textAlign: "center", fontWeight: "500", borderRight: "2px solid #d1d5db" }}>{formatINR(aggA.accessoriesTotal || 0)}</td>
                            <td style={{ padding: "8px", textAlign: "center", color: "#9ca3af", borderRight: "1px solid #e5e7eb" }}>-</td>
                            <td style={{ padding: "8px", textAlign: "center", color: "#9ca3af", borderRight: "1px solid #e5e7eb" }}>-</td>
                            <td style={{ padding: "8px", textAlign: "center", fontWeight: "500", borderRight: "2px solid #d1d5db" }}>{formatINR(aggB.accessoriesTotal || 0)}</td>
                          ...
                          <tr style={{ backgroundColor: "#0f172a" }}>
                            <td style={{ padding: "12px", fontWeight: "600", color: "#ffffff", borderRight: "2px solid #334155" }}>Room Total</td>
                            <td style={{ padding: "12px", textAlign: "center", fontWeight: "600", color: "#ffffff", borderRight: "2px solid #334155" }} colSpan="3">{formatINR(aggA.roomTotal)}</td>
                            <td style={{ padding: "12px", textAlign: "center", fontWeight: "600", color: "#ffffff", borderRight: "2px solid #334155" }} colSpan="3">{formatINR(aggB.roomTotal)}</td>
                            <td style={{ padding: "12px", textAlign: "center" }}>
                              <div style={{ fontSize: "14px", fontWeight: "600", color: roomDifference > 0 ? "#059669" : roomDifference < 0 ? "#dc2626" : "#ffffff" }}>
                                {roomDifference > 0 ? "+" : ""}
                                {formatINR(Math.abs(roomDifference))}
                              </div>
                            </td>
      ...
      {(extrasA.length > 0 || extrasB.length > 0) && (
        <div style={{ padding: "24px 40px", borderBottom: "1px solid #e5e7eb" }}>
          ...
          {(() => {
            ...
            return (
              <>
                <table style={{ width: "100%", fontSize: "14px", border: "1px solid #e5e7eb", marginBottom: "16px" }}>
                  <thead>
                    <tr style={{ backgroundColor: "#1e293b" }}>
                      <th style={{ padding: "12px", textAlign: "left", fontWeight: "500", borderBottom: "1px solid #334155", color: "#ffffff" }}>Service</th>
                      <th style={{ padding: "12px", textAlign: "right", fontWeight: "500", borderBottom: "1px solid #334155", color: "#ffffff" }}>{clientA.name}</th>
                      <th style={{ padding: "12px", textAlign: "right", fontWeight: "500", borderBottom: "1px solid #334155", color: "#ffffff" }}>{clientB.name}</th>
                      <th style={{ padding: "12px", textAlign: "right", fontWeight: "500", borderBottom: "1px solid #334155", color: "#ffffff" }}>Difference</th>
                    </tr>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px", backgroundColor: "#1e293b", border: "1px solid #334155", borderRadius: "4px" }}>
                  <span style={{ fontWeight: "500", color: "#ffffff" }}>Total Additional Services</span>
                  <div style={{ display: "flex", gap: "32px" }}>
                    <div style={{ textAlign: "right" }}>
                      <div style={{ fontSize: "14px", color: "#94a3b8" }}>{clientA.name}</div>
                      <div style={{ fontWeight: "500", color: "#ffffff" }}>{formatINR(extrasTotalA)}</div>
                    </div>
                    <div style={{ textAlign: "right" }}>
                      <div style={{ fontSize: "14px", color: "#94a3b8" }}>{clientB.name}</div>
                      <div style={{ fontWeight: "500", color: "#ffffff" }}>{formatINR(extrasTotalB)}</div>
                    </div>
                    <div style={{ textAlign: "right" }}>
                      <div style={{ fontSize: "14px", color: "#94a3b8" }}>Difference</div>
                      <div style={{ fontWeight: "bold", color: extrasDifference > 0 ? "#059669" : extrasDifference < 0 ? "#dc2626" : "#ffffff" }}>
      ...
      <div style={{ padding: "24px 40px" }}>
        ...
        <table style={{ width: "100%", fontSize: "14px", border: "1px solid #e5e7eb" }}>
          <thead>
            <tr style={{ backgroundColor: "#1e293b" }}>
              <th style={{ padding: "12px", textAlign: "left", fontWeight: "500", borderBottom: "1px solid #334155", color: "#ffffff" }}>Description</th>
              <th style={{ padding: "12px", textAlign: "right", fontWeight: "500", borderBottom: "1px solid #334155", color: "#ffffff" }}>{clientA.name}</th>
              <th style={{ padding: "12px", textAlign: "right", fontWeight: "500", borderBottom: "1px solid #334155", color: "#ffffff" }}>{clientB.name}</th>
              <th style={{ padding: "12px", textAlign: "right", fontWeight: "500", borderBottom: "1px solid #334155", color: "#ffffff" }}>Difference</th>
            </tr>
          ...
          <tbody>
            ...
            <tr style={{ backgroundColor: "#f8fafc" }}>
              <td style={{ padding: "12px", fontWeight: "500", borderTop: "1px solid #e5e7eb", borderBottom: "1px solid #e5e7eb" }}>Subtotal</td>
              <td style={{ padding: "12px", textAlign: "right", fontWeight: "500", borderTop: "1px solid #e5e7eb", borderBottom: "1px solid #e5e7eb" }}>{formatINR(grandTotalA)}</td>
              <td style={{ padding: "12px", textAlign: "right", fontWeight: "500", borderTop: "1px solid #e5e7eb", borderBottom: "1px solid #e5e7eb" }}>{formatINR(grandTotalB)}</td>
              <td style={{ padding: "12px", textAlign: "right", fontWeight: "500", borderTop: "1px solid #e5e7eb", borderBottom: "1px solid #e5e7eb" }}>
                <span style={{ color: getDifference(grandTotalA, grandTotalB) > 0 ? "#059669" : getDifference(grandTotalA, grandTotalB) < 0 ? "#dc2626" : "#1f2937" }}>
            ...
            <tr style={{ backgroundColor: "#0f172a" }}>
              ...
              <td style={{ padding: "12px", textAlign: "right", fontWeight: "bold", color: totalDifference > 0 ? "#059669" : totalDifference < 0 ? "#dc2626" : "#ffffff" }}>
      ...
      {/* Footer */}
      <div style={{ borderTop: "3px solid #0f172a", padding: "24px 40px", backgroundColor: "#1e293b" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <h4 style={{ fontWeight: "500", color: "#ffffff", marginBottom: "8px" }}>Contact Details</h4>
            <p style={{ fontSize: "14px", color: "#94a3b8", marginBottom: "4px" }}>{(company ?? config.platform).phones.join(" | ")}</p>
            <p style={{ fontSize: "14px", color: "#94a3b8" }}>{(company ?? config.platform).email}</p>
          </div>
          <div style={{ textAlign: "right" }}>
            <h4 style={{ fontWeight: "500", color: "#ffffff", marginBottom: "8px" }}>Report Notes</h4>
            <ul style={{ fontSize: "14px", color: "#94a3b8", padding: 0, margin: 0, listStyle: "none" }}>
...
function SummaryCard({ label, valueA, valueB, highlight = false }) {
  ...
  return (
    <div style={{ border: highlight ? "1px solid #0f172a" : "1px solid #e5e7eb", borderRadius: "6px", padding: "12px" }}>
